...
public class DefaultLastHttpContent extends DefaultHttpContent implements LastHttpContent {
    ...
    private static final class TrailingHeaders extends DefaultHttpHeaders {
        ...
        void validateHeaderName0(CharSequence name) {
            ...
            if (HttpHeaders.equalsIgnoreCase(Names.CONTENT_LENGTH, name) ||
                    HttpHeaders.equalsIgnoreCase(Names.TRANSFER_ENCODING, name) ||
                    HttpHeaders.equalsIgnoreCase(Names.TRAILER, name)) {
