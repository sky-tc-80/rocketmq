...
final class PoolChunk<T> implements PoolChunkMetric {
    ...
    /**
     * PoolChunk 中所有的 PoolSubpage 都放在 PoolSubpage[] subpages中，为了更好的分配，Netty 用一颗平衡二叉树记录每个 PoolSubpage 的分配情况。为了直观的举例，我以一个 maxOrder=3 的PoolChunk 来说明 memoryMap 中存放的数据
     *
     *  order(dept)=0                                 0
     *                                          /         \
     *
