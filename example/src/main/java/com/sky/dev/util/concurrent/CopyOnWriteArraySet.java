...
import com.sky.dev.util.AbstractSet;
import java.util.Iterator;
import java.util.Spliterator;
import com.sky.dev.util.Spliterators;
...
public class CopyOnWriteArraySet<E> extends AbstractSet<E>
    ...
    public CopyOnWriteArraySet(Collection<? extends E> c) {
        if (c.getClass() == com.sky.dev.util.concurrent.CopyOnWriteArraySet.class) {
            @SuppressWarnings("unchecked") com.sky.dev.util.concurrent.CopyOnWriteArraySet<E> cc =
                (com.sky.dev.util.concurrent.CopyOnWriteArraySet<E>)c;
